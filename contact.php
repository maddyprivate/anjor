...
<section id="page-content" class="sidebar-right">
    <div class="container">
            ...
            <div class="col-lg-6">
                ...
                <div class="icon-box effect medium border mb-3">
                    ...
                    <p>
                        ...
                        1, Kranti Nagar Rd, Kashid Park, Kranti Nagar, Pimple Gurav, Pimpri-Chinchwad, Pune, Maharashtra
                        411061
                ...
                <div class="icon-box d-block effect medium border">
                    <div class="icon"> <a
                            href="/cdn-cgi/l/email-protection#1e7d71706a7f7d6a307a76796a5e79737f7772307d7173"><i
                                class="fas fa-envelope"></i></a> </div>
                    <h3 class="fw-bold mb-1">EMAIL</h3>
                    <p>
                        <a href="/cdn-cgi/l/email-protection#70131f1e041113045e1418170430171d11191c5e131f1d"
                            class="lh-lg d-block mb-2"><span class="__cf_email__"
                                data-cfemail="b1d2dedfc5d0d2c59fd5d9d6c5f1d6dcd0d8dd9fd2dedc">trimurtishaktipith@gmail.com</span></a>
                    </p>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row mt-6">
            <div class="col-lg-6">
                ...
                <div class="text-center">
                    <a href="./social-initiatives" class="btn btn-warning">
                        CLICK HERE </a>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
            <a class="icon-box-2" href="./donateus.php">
                <div class="box-text">
