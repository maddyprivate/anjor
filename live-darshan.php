<?php include 'header.php'; ?>
            ...
            <section class="fullscreen" data-bg-parallax="/dg/image1.jpg">
            ...
            <div class="row">
                ...
                <div class="content col-lg-8">
                    <h2 class="fw-bold text-uppercase mb-3">The live Darshan of Trimurti Shakti Pith from the Temple</h2>
                                            ...
                                            <iframe loading="lazy"
                            src=""
                            width="100%" height="315" frameborder="0" scrolling="no" seamless=""
                    ...
                    <iframe width="560" height="400" src=""
                        title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        allowfullscreen></iframe>
                    ...
                    <div class="row mt-6">
                        <div class="col-lg-6">
                            <div class="card bg-green">
                                ...
                                <img class="card-img-top" src="./dg/misc/yag-abhishek.webp" alt="ESeva">
                                <a class="card-body text-center" href="./eseva">
                                    <h3 class="card-title text-white mb-2">E-SEVA</h3>
                                </a>
                            </div>
                            <div class="text-center">
                                <a href="./eseva"
                                    class="btn btn-warning mt-1 mb-5">BOOK NOW</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card bg-green-light">
                                <img class="card-img-top" src="./dg/misc/donations.webp" alt="E-Donation">
                                <a class="card-body text-center" href="./donation">
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-6">
                            <div class="card bg-purple">
                                <img class="card-img-top" src="./dg/misc/social-Initiatives.webp"
                                    alt="Social Initiatives">
                                <a class="card-body text-center"
                                    href="./social-initiatives">
                                    <h3 class="card-title text-white mb-2 text-uppercase">Social Initiatives</h3>
                                </a>
                            </div>
                            <div class="text-center">
                        ...
                        <div class="col-lg-6">
                            <div class="card bg-bluish">
                                <span class="badge bg-success">POPULAR</span>
                                <img class="card-img-top" src="./dg/misc/tatkal-darshan.webp"
                                    alt="Tatkal Darshan Pass">
                                <a class="card-body text-center" href="./fasttrack">
                                    <h3 class="card-title text-white mb-2 text-uppercase">Tatkal Darshan Pass</h3>
                                </a>
                            </div>
                            <div class="text-center">
                                <a href="./fasttrack"
