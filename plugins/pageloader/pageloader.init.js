    ...
    init: function () {
        ...
        if (typeof $.fn.animsition === "undefined") {
            INSPIRO.elements.notification(
                "Warning",
                "Pageloader plugin is missing, please add this code line <b> &lt;script src=&quot;plugins/pageloader/pageloader.js&quot;&gt;&lt;/script&gt;</b>, after <b>functions.js</b>",
                "danger"
            );
            return true;
        }
        if (!$body.hasClass("no-page-loader")) {
            ...
            if (options.loaderIconColor) {
                $("head").append(
                    '<style type="text/css">' + iconColor + "</style>"
                );
            }
            var innerHTMLcode = "";
            if (options.customMessage) {
                ...
                innerHTMLcode =
                    '<div class="loader">' + loadingInnerHTML + "</div>";
            }
            if ($("#wrapper").length > 0) {
                $bodyInner = $("#wrapper");
            } else {
            ...
            $bodyInner.animsition({
                ...
                loadingInner:
                    '<div class="loader">' + loadingInnerHTML + "</div>",
                linkElement:
                    '#page-menu a, #mainMenu a:not([target="_blank"]):not([href*="#"]):not([data-lightbox]):not([href^="mailto"]):not([href^="tel"]):not([href^="sms"]):not([href^="call"]), .animsition-link, .slide-link',
            });
