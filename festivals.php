    ...
    <div class="container">
        <div class="row">
            ...
            <div class="content col-lg-8">
                ...
                <p class="p-large">
                    <span class="dropcap dropcap-dark me-3">E</span>Lorem ipsum dolor sit amet, consectetur adipiscing
                    elit. Nullam tristique felis at malesuada pharetra. Aenean at sollicitudin purus. Phasellus sit amet
                    nisi quis nulla suscipit sodales. Curabitur quis turpis vitae lorem egestas scelerisque in sit amet
                    nisi. Duis accumsan sollicitudin ante, et tempor lectus luctus ac. Suspendisse vehicula, urna nec
                    ...
                    <div class="col-lg-6">
                        <a class="card festival" href="https://www..com/festivals/ganesh-janm"
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="text-white">
                                    Celebrated with devotion and enthusiasm, this festival honors the birth of
                                    Dattatraya, who is believed to be an incarnation of the divine trinity of Brahma,
                                    Vishnu, and Shiva.
                                </p>
                            </div>
                        </a>
                        <div class="text-center">
                            <a href="#" class="btn btn-warning mt-1 mb-5">CLICK HERE</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <a class="card festival" href="https://www..com/festivals/suryaful-mahotsav"
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="text-white">
                                    This significant day commemorates the appearance of Swami Samarth on Earth, marking
                                    a profound moment in the spiritual landscape of the region.
                                </p>
                            </div>
                        </a>
                        <div class="text-center">
                    ...
                    <div class="col-lg-6">
                        <a class="card festival" href="https://www..com/festivals/vallabhesh-mangalam"
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="text-white">
                                    This date is traditionally celebrated as the birth anniversary or Prakat Din
                                    (Appearance Day) of Sai Baba.
                                </p>
                            </div>
                        </a>
                        <div class="text-center">
                    ...
                    <div class="col-lg-6">
                        <a class="card festival" href="https://www..com/festivals/amba-mahotsav"
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="text-white">
                                    The term “Guru Purnima” is derived from two Sanskrit words: “Guru,” meaning teacher
                                    or guide, and “Purnima,” meaning full moon.
                                </p>
                            </div>
                        </a>
                        <div class="text-center">
