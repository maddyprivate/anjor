                ...
                <div class="content col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card eseva">
                                ...
                                <img class="card-img-top" src="https://www.dagdushethganpati.com/dg/eseva/eseva-booking-1.webp" alt="ESeva">
                                <div class="card-body text-center">
                                    ...
                                    <a href="https://seva.dagdushethganpati.com/seva_detail?eseva_id=Mjc4"
                        ...
                        <div class="col-lg-6">
                            <div class="card eseva">
                                <span class="badge bg-danger">NEW</span>
                                <img class="card-img-top" src="https://www.dagdushethganpati.com/dg/eseva/eseva-booking-2.webp" alt="ESeva">
                                <div class="card-body text-center">
                                    ...
                                    <a href="https://seva.dagdushethganpati.com/seva_detail?eseva_id=Mjgx"
                                        class="btn btn-warning">
                                        BOOK NOW                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card eseva">
                                ...
                                <img class="card-img-top" src="https://www.dagdushethganpati.com/dg/eseva/eseva-booking-3.webp" alt="ESeva">
                                <div class="card-body text-center">
                                    <h3 class="card-title mb-4 text-uppercase">Daily Maha-Abhishek (Nitya Abhishek)</h3>
                                    <div class="cost pt-3 mb-4"><span>₹</span> 251/-</div>
                                    <a href="https://seva.dagdushethganpati.com/seva_detail?eseva_id=MzA2"
                                        class="btn btn-warning">
                                        BOOK NOW                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card eseva">
                                <img class="card-img-top" src="https://www.dagdushethganpati.com/dg/eseva/eseva-booking-4.webp" alt="ESeva">
                                <div class="card-body text-center">
                                    <h3 class="card-title mb-4 text-uppercase">
                                        Ganesh Yag                                    </h3>
                                    <div class="cost pt-3 mb-4"><span>₹</span> 21000/-</div>
                                    <a href="https://seva.dagdushethganpati.com/seva_detail?eseva_id=Mjg0"
                                        class="btn btn-warning">
                                        BOOK NOW                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card eseva">
                                <img class="card-img-top"
                                    src="https://www.dagdushethganpati.com/dg/eseva/eseva-booking-5-Sahasravartan-Pooja.webp" alt="ESeva">
                                <div class="card-body text-center">
                                    <h3 class="card-title mb-4 text-uppercase">Sahasravartan Pooja</h3>
                                    <div class="cost pt-3 mb-4"><span>₹</span> 6001/-</div>
                                    <a href="https://seva.dagdushethganpati.com/seva_detail?eseva_id=Mjk3"
                                        class="btn btn-warning">
                                        BOOK NOW                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card eseva">
                                <img class="card-img-top"
                                    src="https://www.dagdushethganpati.com/dg/eseva/eseva-booking-6-Satyavinayak-Pooja.webp" alt="ESeva">
                                <div class="card-body text-center">
                                    <h3 class="card-title mb-4 text-uppercase">Satyavinayak Pooja</h3>
                                    <div class="cost pt-3 mb-4"><span>₹</span> 1100/-</div>
                                    <a href="https://seva.dagdushethganpati.com/seva_detail?eseva_id=Mjk4"
                                        class="btn btn-warning">
                                        BOOK NOW                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card eseva">
                                <img class="card-img-top"
                                    src="https://www.dagdushethganpati.com/dg/eseva/eseva-booking-7-Fruit-Offering-Service.webp"
                                    alt="ESeva">
                                <div class="card-body text-center">
                                    <h3 class="card-title mb-4 text-uppercase">Fruit Offering Service</h3>
                                    <div class="cost pt-3 mb-4"><span>₹</span> 3100/-</div>
                                    <a href="https://seva.dagdushethganpati.com/seva_detail?eseva_id=Mjkz"
                                        class="btn btn-warning">
                                        BOOK NOW                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card eseva">
                                <img class="card-img-top"
                                    src="https://www.dagdushethganpati.com/dg/eseva/eseva-booking-8-Daily-Garland-Service.webp" alt="ESeva">
                                <div class="card-body text-center">
                                    <h3 class="card-title mb-4 text-uppercase">Daily Garland Service</h3>
                                    <div class="cost pt-3 mb-4"><span>₹</span> 2100/-</div>
                                    <a href="https://seva.dagdushethganpati.com/seva_detail?eseva_id=Mjky"
                                        class="btn btn-warning">
                                        BOOK NOW                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="row mt-6">
                        <div class="col-lg-6">
                            <div class="card bg-purple">
                                ...
                                <a class="card-body text-center"
                                    href="https://www.dagdushethganpati.com/social-initiatives">
                        ...
                        <div class="col-lg-6">
                            <div class="card bg-magenta">
                                ...
                                <a class="card-body text-center" href="https://seva.dagdushethganpati.com/donation">
                                    <h3 class="card-title text-white mb-2">E-DONATION</h3>
                                </a>
                            </div>
                            <div class="text-center">
                                <a href="https://seva.dagdushethganpati.com/donation"
                                    class="btn btn-warning mt-1 mb-5">CLICK HERE</a>
                            </div>
                        </div>
                    </div>
