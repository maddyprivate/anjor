                    ...
                    <div class="col-lg-4">
                        <div class="widget">
                            ...
                            <p class="mb-4 text-light lh-lg">
                                The Shri Datta Maharaj Trimurti Shakti Pith is located in Pune and is under the
                                management of the "Anjor Foundation," registered under No. E – 5525 in Pune.
                            </p>
                    ...
                    <div class="col-lg-3">
                        <div class="widget">
                            ...
                            <div class="icon-box effect small clean mb-3">
                                ...
                                <div class="icon">
                                    <div class="icon-holder"><i class="fas fa-map-marker-alt"></i>
                                    </div>
